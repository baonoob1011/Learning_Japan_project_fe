...
export default function ContactsList({
  ...
  return (
    <div
      className={`w-[380px] border-r flex flex-col shadow-xl transition-colors duration-300 ${isDarkMode
    ...
    >
      {/* Header */}
      <div
        className={`p-6 border-b transition-colors duration-300 ${isDarkMode
      ...
      >
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <button
              className={`p-2 rounded-full transition-colors ${isDarkMode ? "hover:bg-gray-700" : "hover:bg-cyan-100"
                }`}
            >
              <MoreVertical
        ...
        <div className="flex items-center gap-3">
          <div className="relative flex-1 group">
            <Search
              className={`absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 transition-colors ${isDarkMode
            ...
            <input
              ...
              className={`w-full pl-10 pr-4 py-2.5 border rounded-xl focus:outline-none focus:ring-2 transition-all text-sm ${isDarkMode
          ...
          <div className="relative">
            <button
              ...
              title="Tạo nhóm mới"
              className={`p-2.5 rounded-xl border transition-all hover:scale-105 active:scale-95 ${isDarkMode
                ? "bg-gray-700 border-gray-600 text-cyan-400 hover:bg-gray-600"
      ...
      {/* Tabs */}
      <div
        className={`flex border-b ${isDarkMode
      ...
      >
        <button
          ...
          className={`flex-1 py-3 text-sm font-semibold border-b-2 transition-colors ${activeTab === "INBOX"
            ? isDarkMode
        ...
        <button
          ...
          className={`flex-1 py-3 text-sm font-semibold border-b-2 transition-colors flex items-center justify-center gap-1.5 ${activeTab === "GROUP"
            ? isDarkMode
              ? "text-cyan-400 border-cyan-500"
              : "text-cyan-700 border-cyan-500"
            : isDarkMode
      ...
      {/* List */}
      <div
        className={`flex-1 overflow-y-auto ${isDarkMode ? "custom-scrollbar-dark" : "custom-scrollbar"
          }`}
      >
        {activeTab === "INBOX" ? (
          <InboxList

        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-4 text-sm text-gray-500 mt-1">
                  <span className="flex items-center gap-1">
                    ...
                    {dashboardData.user?.email || "No Email"}
                  </span>
                  <span className="flex items-center gap-1">
            ...
            <div className="flex items-center gap-3">
              ...
              >
                <History className="w-4 h-4 text-blue-500" /> Hoạt động cộng
                đồng
              </button>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
              <h2 className="text-xl font-bold text-gray-800 mb-6 flex items-center gap-2">
                <TrendingUp className="w-6 h-6 text-indigo-500" /> Tiến độ 7
                ngày qua
              </h2>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
              <h2 className="text-xl font-bold text-gray-800 mb-6 flex items-center gap-2">
                <BarChart3 className="w-6 h-6 text-indigo-500" /> Thống kê theo
                cấp độ
              </h2>
              <ResponsiveContainer width="100%" height={250}>
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-3">
                <div className="flex justify-between p-3 bg-green-50 rounded-lg">
                  <span className="flex items-center gap-2 text-sm text-gray-700">
                    <div className="w-2 h-2 rounded-full bg-green-500"></div>Câu
                    đúng
                  </span>
                ...
                <div className="flex justify-between p-3 bg-red-50 rounded-lg">
                  <span className="flex items-center gap-2 text-sm text-gray-700">
                    <div className="w-2 h-2 rounded-full bg-red-500"></div>Câu
                    sai
                  </span>
            ...
            <div className="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl p-6 text-white shadow-lg">
              <h2 className="text-lg font-bold mb-4 flex items-center gap-2">
                <Target className="w-5 h-5" /> Tiến độ mục tiêu
              </h2>
              <div className="space-y-4">
                <div>
                  <div className="flex justify-between text-sm mb-2 opacity-90">
                    ...
                    <span>
                      {Math.round((dashboardData.totalExamsTaken / 50) * 100)}%
                    </span>
                  </div>
                  <div className="w-full bg-black/20 rounded-full h-2">
                    <div
                      ...
                      style={{
                        width: `${Math.min(
                          (dashboardData.totalExamsTaken / 50) * 100,
                          100
                        )}%`,
                      }}
                    />
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
              <h3 className="font-bold text-lg mb-4 flex items-center gap-2 text-gray-800">
                <MessageSquare className="w-5 h-5 text-indigo-500" /> Hoạt động
                gần đây
              </h3>
              <div className="space-y-4">
                ...
                <tbody className="divide-y divide-gray-100">
                  <tr className="hover:bg-gray-50 transition-colors">
                    <td className="p-4 font-medium text-gray-700">
                      Đã chia sẻ tài liệu &ldquo;Tổng hợp Kanji N3&rdquo;
                    </td>
                    <td className="p-4">
                    ...
                    <td className="p-4 text-right">
                      <button className="text-red-500 hover:text-red-700 hover:underline text-xs font-bold">
                        Gỡ bỏ
                      </button>
                    </td>
                  </tr>
                  <tr className="hover:bg-gray-50 transition-colors">
                    <td className="p-4 font-medium text-gray-700">
                      Bình luận tại bài viết &ldquo;Lộ trình học N2&rdquo;
                    </td>
                    <td className="p-4">
                  ...
                  <tr className="hover:bg-gray-50 transition-colors">
                    <td className="p-4 font-medium text-gray-700">
                      Đăng câu hỏi &ldquo;Ngữ pháp N1 này dùng sao?&rdquo;
                    </td>
                    <td className="p-4">

...
import { userService, UserResponse } from "@/services/userService"; // <-- Nhớ sửa đường dẫn import đúng file của bạn
...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        setLoading(true);
        // Lấy 5 user mới nhất để hiển thị ở Dashboard
  ...
  const getLevelBadgeColor = (level?: string) => {
    if (!level) return "bg-gray-100 text-gray-600"; // Mặc định nếu null
  ...
  return (
    <div className="flex bg-gray-50 min-h-screen font-sans">
      ...
      <main className="ml-64 flex-1 p-8">
        ...
        {/* 1. KEY METRICS (Tĩnh - Có thể gọi API thống kê riêng sau này) */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          {/* 2. CỘT TRÁI: Danh sách User & Tiến độ */}
          <div className="lg:col-span-2 space-y-8">
            ...
            {/* Biểu đồ phân bổ JLPT (Giữ nguyên tĩnh hoặc làm API riêng sau) */}
          ...
          {/* 3. CỘT PHẢI: Thông báo & Cộng đồng (Giữ nguyên tĩnh) */}
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100">
                ...
                <div className="p-4 space-y-4">
                    {/* ... Nội dung thông báo cũ giữ nguyên ... */}
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100">
                ...
                {/* ... Nội dung báo lỗi cũ giữ nguyên ... */}
                <div className="p-4 space-y-4">
